//vetor(array) global para armazenar os itens do pedido
var itens = []
...
//cria referência ao elemento e associa a função ao evento focus
...
inDetalhes.addEventListener('keypress', function (tecla) {
    ...
    if (tecla.keyCode == 13) {
        adicionarItem()     //irá adocionar item no pedido
    }
})
...
function limparCampos() {
    ...
    inBebida.className = "oculta"       //oculta select das Bebidas
    inPizza.className = "exibe"         //exbie select das Pizzas
