...
function adicionarCriancas() {
    ...
    //limpa campo e posiciona cursor em inNome
    inNome.value = ''
    inIdade.value = ''
    inNome.focus()
...
//cria referência ao btListar e associa function ao evento click deste botão
...
function resumirLista() {
    ...
    var resumo = ''         //variável para concatenar a saída
    ...
    for (var i = 0; i < copia.length; i++) {
        //se é da mesma idade auxiliar, adiviona ao vetor
    ...
    //adiciona os nomes da útima idade ordenada
...
//cria referência ao btResumir e associa function ao evento click deste botão
