var carros = []     //declara array vazio escopo global
...
function adicionarCarros() {
    ...
    //limpar campos e posiciona cursor em inModelo
    inModelo.value = ''
    inPreco.value = ''
    inModelo.focus()
...
//cria referência ao btAdicionar e associa function ao evento click desse botão
...
function listarCarros() {
    ...
    //referência elemento e altera conteúdo exibido
    document.getElementById('outLista').textContent = lista
}
//cria referência ao  btListar eassocia a function ao evento click dessse botão
...
//cria referência ao elemento btFiltrar e associa function ao evento click desse botão
